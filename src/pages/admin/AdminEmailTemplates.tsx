...
const TEMPLATE_LABELS: Record<string, { name: string; description: string; badge: string }> = {
    welcome_creator: { name: "1. Registro — Creador", description: "Al registrarse un nuevo creador (Pide completar onboarding)", badge: "Creador" },
    creator_pending: { name: "2. Pendiente — Creador", description: "Al completar su perfil y quedar en revisión", badge: "Creador" },
    creator_activated: { name: "3. Activada — Creador", description: "Al ser aprobada su cuenta por un administrador", badge: "Creador" },
    welcome_brand: { name: "1. Registro — Marca", description: "Al registrarse una nueva marca (Pide completar onboarding)", badge: "Marca" },
    brand_pending: { name: "2. Pendiente — Marca", description: "Al completar el perfil de empresa y quedar en revisión", badge: "Marca" },
    brand_activated: { name: "3. Activada — Marca", description: "Al ser aprobada la cuenta de la marca", badge: "Marca" },
    application_received: { name: "Nueva Aplicación", description: "La marca recibe una aplicación", badge: "Marca" },
    invitation_accepted: { name: "Invitación Aceptada", description: "El creador aceptó la invitación", badge: "Marca" },
    ...
    password_reset: { name: "Restablecer Contraseña", description: "El usuario solicita cambiar su contraseña", badge: "Todos" },
};
    ...
    const handleSeedTemplates = async () => {
        ...
        try {
            ...
            const templates: Record<string, any> = {
                ...
                invitation_accepted: { subject: "🎉 {{creatorName}} aceptó tu invitación", variables: ["brandName", "creatorName", "campaignTitle", "matchesUrl"], html: w("🎉 Invitación Aceptada", "Un creador aceptó colaborar", "<p>Hola <strong>{{brandName}}</strong>, <strong>{{creatorName}}</strong> ha aceptado tu invitación para la campaña <strong>{{campaignTitle}}</strong>.</p>", "Ver Creador", "{{matchesUrl}}") },
                ...
                content_approved: { subject: "🎉 ¡Contenido aprobado! — {{campaignTitle}}", variables: ["creatorName", "campaignTitle", "earningsUrl", "pendingItemsText"], html: w("🎉 ¡Aprobado!", "Tu pago se procesará pronto", "<p>Hola <strong>{{creatorName}}</strong>, tu contenido para <strong>{{campaignTitle}}</strong> fue aprobado.</p><p>{{pendingItemsText}}</p>", "Ver Ganancias", "{{earningsUrl}}") },
