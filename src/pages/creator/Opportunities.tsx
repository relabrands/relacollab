      ...
      try {
        ...
        const invitationsPromises = invSnapshot.docs.map(async (invDoc) => {
          ...
          if (campaignSnap.exists()) {
            ...
            return {
              ...
              ...campaignData,
              brandName: campaignData.brandProfileName || brandData.brandName || campaignData.brandName || brandData.displayName || "Unknown Brand",
        ...
        const generalOpportunities = await Promise.all(querySnapshot.docs.map(async (docSnap) => {
          ...
          return {
            id: docSnap.id,
            ...data,
            brandName: data.brandProfileName || brandData.brandName || data.brandName || brandData.displayName || "Unknown Brand",
            brandLogo: data.brandProfileLogo || brandData.photoURL || brandData.avatar || data.brandLogo || "",
            title: data.name,
            matchScore: score,
            isInvited: false,
