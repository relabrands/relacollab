      ...
      try {
        ...
        const invitationsPromises = invSnapshot.docs.map(async (invDoc) => {
          ...
          if (campaignSnap.exists()) {
            ...
            return {
              ...
              ...campaignData,
              brandName: brandData.brandName || campaignData.brandName || brandData.displayName || "Unknown Brand",
              brandLogo: brandData.photoURL || brandData.avatar || campaignData.brandLogo || "",
        ...
        const generalOpportunities = await Promise.all(querySnapshot.docs.map(async (docSnap) => {
          ...
          return {
            id: docSnap.id,
            ...data,
            brandName: brandData.brandName || data.brandName || brandData.displayName || "Unknown Brand",
            brandLogo: brandData.photoURL || brandData.avatar || data.brandLogo || "",
            title: data.name,
            matchScore: score,
            isInvited: false,
