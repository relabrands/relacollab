...
export default function BrandReports() {
    ...
    const creatorMetrics = Object.values(
        submissions.reduce((acc: any, s) => {
            ...
            if (!acc[cid]) {
                acc[cid] = { cid, views: 0, reach: 0, likes: 0, comments: 0, saved: 0, shares: 0, posts: 0 };
            }
            acc[cid].posts++;
                                        ...
                                        <tbody>
                                            {creatorMetrics
                                                ...
                                                .map((cm, i) => {
                                                    ...
                                                    return (
                                                        <tr key={cm.cid} className="border-b border-border/50 hover:bg-muted/30 transition-colors">
                                                            <td className="py-3 pr-4">
                                                                <div className="flex items-center gap-3">
                                                                    {profile.photoURL ? (
                                                                        <img src={profile.photoURL} className="w-8 h-8 rounded-full object-cover" />
                                                                    ) : (
