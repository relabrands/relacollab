...
import { Send, Search, Calendar, MapPin, Loader2 } from "lucide-react";
        ...
        const fetchCollaborations = async () => {
            ...
            try {
                ...
                for (const appDoc of appsSnapshot.docs) {
                    ...
                    // Fetch campaign to get brand info
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <p className="font-medium truncate">{collab.creatorName}</p>
                            ...
                            <>
                                ...
                                <div className="p-4 border-b flex items-center gap-4">
                                    <Avatar className="w-12 h-12">
                                        <AvatarImage src={selectedCollab.creatorAvatar} />
                                        <AvatarFallback>{selectedCollab.creatorName.charAt(0)}</AvatarFallback>
                                    </Avatar>
                                    <div className="flex-1">
                                        <h3 className="font-semibold">{selectedCollab.creatorName}</h3>
